...
Follow-up prompts use the same streaming agent endpoint. The preview iframe loads the backend-provided `http://project.tarunn.co/workspace/<runtimeId>/` URL. The code pane and WebSocket-based file/status UI remain placeholders.
